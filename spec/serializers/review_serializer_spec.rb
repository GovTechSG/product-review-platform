...
RSpec.describe ReviewSerializer, type: :serializer do
  context 'Individual Resource Representation' do
    ...
    subject { ReviewSerializer.new(@review, root: false).as_json["object"].merge("reviewer" => @review.reviewer, "reviewable" => @review.reviewable, "grant" => @review.grant, "aspects" => @review.aspects) }
